 ...
 */
final class Version20220803234000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prioridade (id INT AUTO_INCREMENT NOT NULL, nome_prioridade VARCHAR(100) DEFAULT NULL, cor VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE situacao (id INT AUTO_INCREMENT NOT NULL, descricao VARCHAR(200) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE funcionario ADD is_admin TINYINT(1) DEFAULT NULL, ADD is_ativo TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE funcionario DROP is_admin, DROP is_ativo');
    }
}
