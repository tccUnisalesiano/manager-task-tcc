 ...
 */
final class Version20220821201944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarefa ADD porcentagem INT DEFAULT NULL, CHANGE nome_tarefa status VARCHAR(100) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarefa DROP porcentagem, CHANGE status nome_tarefa VARCHAR(100) DEFAULT NULL');
    }
}
